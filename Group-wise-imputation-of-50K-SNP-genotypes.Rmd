...
# Load inputs
markerinfo <- readRDS("./FinalGenotypeFile20251104.Rds")
annotUC <- readRDS("./DRAFT-10-15-2024-Final_Rosetta_istraw&50K&850K.Rds")
annotUF <- read.table("./FaFB1_vf_pos.txt", header=TRUE, stringsAsFactors=FALSE)
...
if(length_zero > 0){
  ...
  write.table(data.frame(Probe_ID = removed_snps),
              file = "./removed_zero_variance_snps.tsv",
              sep = "\t", row.names = FALSE, quote = FALSE)
  message("Wrote ./removed_zero_variance_snps.tsv")
}
