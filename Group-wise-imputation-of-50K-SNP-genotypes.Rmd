...
Problem_Samples <- c("20B251P105", "20B251P029", "20C420P052", "72C501P002")
geno <- geno %>% filter(!Entry %in% Problem_Samples)
...
Heirloom (non UC or UF)

Wild: Fragaria chiloensis

Wild: Fragaria virginiana


If a sample is labeled Wild we subdivide by species. Also we place Yasmin into the UF group because of its breeding history.
